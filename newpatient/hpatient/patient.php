...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<img class="profile-pic" src="images/img3.jpg" height="200px"></img>
				<!--links on side Navigation bar-->
					<ul class="nav nav-sidebar">
						<ul class="nav nav-tabs nav-stacked">
							<li id="link1" class="active"><a data-toggle="tab" href="#Patient_homepage" onclick="fun_notice()">Home Page</a></li>
							
							<li id="link2" ><a data-toggle="tab" href="#History" onClick="fun_payment()">History</a></li>
							<li id="link3"><a data-toggle="tab" href="#Admit_info" onclick="fun_admitroom()">Admit Information</a></li>
							<li id="link4"><a data-toggle="tab" href="#Prescription" onclick="fun_prescription()">View Prescription</a></li>
							
							<li id="link6"><a data-toggle="tab" href="#Appointment" onclick="fun_appointment()">View Appointment</a></li>
							<!--			<li id="link7"><a data-toggle="tab" href="#Preference">My preference</a></li>   -->
							<li id="link8"><a data-toggle="tab" href="#Viewdocap">Search Doctor and Book an appointment</a></li>
						...
						<h1 class="page-header">Patient Dashboard</h1>
							...
							<div class="table-responsive">
								<ul class="nav nav-pills" role="tablist" >
									...
									<a onclick="nav_set(2);fun_payment();" data-toggle="tab" href="#History" ><img src="images/patient/history.png" height="150px"></img></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
									<a onclick="nav_set(8)" data-toggle="tab" href="#Viewdocap"><img src="images/patient/search_doc.jpg" height="200px"></img></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
									<a onclick="nav_set(6);fun_appointment();" data-toggle="tab" href="#Appointment"><img src="images/patient/appointment1.jpg" height="200px"></img></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
									<a onclick="nav_set(4);fun_prescription();" data-toggle="tab" href="#Prescription" ><img src="images/patient/prescription.jpg" height="150px"></img></a>
									<br><br>
								</ul>  
							</div>
							<div class="row placeholders">
								...
								<div class="col-xs-4 col-sm-4 placeholder">
									...
									<br />
									<h3><span class="label label-success">HEART TIPS.</span></h3>
									<br />
    ...
    function deleteappointment()
    {
	 ...
	 var x;
    	if (confirm("Are your sure that you want to cancel this appointment !!\n You may need to wait for long to get another appointment !!") == true) 
		{
			...
			xmlhttp.open("POST","remove_app.php?presid="+presid,false);
			xmlhttp.send(null);
		} //end of if  
		else {
				alert("not deleted");
	...
	function display_doctor1()
		...
		{
		 alert("your appointmen will be booked");
		 var selected_wait_row=event.currentTarget;
		 var child_nodes=selected_wait_row.parentNode.parentNode.childNodes;
	     var doctor_id=child_nodes[2].innerHTML;
		 //alert(doctor_id);
		 alert("PLEASE CHECK YOUR Appoinement LIST !! For any questions contact us !!");
		...
		xmlhttp.open("POST","time_test2.php?docid="+doctor_id,false);
		xmlhttp.send(null);
